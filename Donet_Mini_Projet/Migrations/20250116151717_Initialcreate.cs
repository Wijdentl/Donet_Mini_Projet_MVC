    ...
    public partial class Initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(25)", nullable: false),
                    UserName = table.Column<string>(type: "varchar(25)", maxLength: 256, nullable: true),
                    NormalizedUserName = table.Column<string>(type: "varchar(25)", maxLength: 256, nullable: true),
                    Email = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true),
                    NormalizedEmail = table.Column<string>(type: "varchar(25)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    RoleId = table.Column<string>(type: "varchar(25)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoginProvider = table.Column<string>(type: "varchar(25)", nullable: false),
                    ProviderKey = table.Column<string>(type: "varchar(25)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoutMainDOeuvre = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Statut = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PieceDeRechanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PieceDeRechanges_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PieceDeRechanges_Interventions_InterventionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PieceDeRechanges_ArticleId",
                table: "PieceDeRechanges",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_PieceDeRechanges_InterventionId",
                table: "PieceDeRechanges",
